...
import { FaCodepen, FaUser, FaStore, FaUserFriends, FaCode} from 'react-icons/fa'
      ...
      <div className="w-full mx-auto lg:w-10/12">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-3 md-grid-cols-3 mb-8 md:gap-8">
          <div className="custom-card-image mb-6 md:mb-0">
            <div className="rounded-lg shadow-lx card-image-full">
              ...
              <div className="card-body justify-end">
                <h2 className="h2 card-title mb-0">
                  {name}
                </h2>
                <p>{login}</p>
              </div>
          ...
          <div className="col-span-2">
            ...
            <div className="w-full w-rounded-lg shadow-md bg-base-100 stats">
              {location && (
                <div className="stat">
              ...
              {twitter_username && (
                <div className="stat">
                  ...
                  <div className="text-lg stat-value">
                    <a href={`https://${twitter_username}`} target="_blank" rel="noreferrer">
                      {twitter_username}
                    </a>
                  </div>
                </div>
